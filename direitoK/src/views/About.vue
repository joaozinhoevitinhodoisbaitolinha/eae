  ...
  <div class="pa-3">
    ...
    <section>
      <p>
        ...
        <v-card-text>
        <strong>E-mail:</strong> marcioapocallypse@gmail.com<br>
        <strong>Marcio Alves </strong><br>
        <img src="../assets/octocat.png" height="20px" alt="imagem octocat" /> <a href="https://github.com/MarcioAMartins">/MarcioAMartins</a>
        </v-card-text>
      </p>
    </section>
